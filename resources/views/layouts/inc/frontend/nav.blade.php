        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name"> <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}">
                                <i class="fa fa-heart"></i> {{ __('Login') }}
                            </a>
                        </li>
                        @endif 
                            ...
                            @if (Route::has('register')) 
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}">
                                        <i class="fa fa-heart"></i> {{ __('Register') }}
                                    </a>
                                </li>
                            @endif
                        @else
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('front.category')}}">All Categories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/arrivals')}}">New Arrivals</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/orders')}}">MyOrder</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Home</a>
                    </li>
